...
namespace Alsing.Windows.Forms
{
    ...
    public class SyntaxBoxControl : SplitViewParentControl
    {
		...
		private EditViewControl.AutolistTextInsertedDelegate _AutoListInsertSelectedText;
		public EditViewControl.AutolistTextInsertedDelegate OnAutoListTextInserted
        {
			get { return _AutoListInsertSelectedText;  }
			set
			{
				EditViewControl ed = _ActiveView as EditViewControl;
				if (ed != null)
				{
					ed.AutolistTextInserted = value;
					ed.InsertAutolistText();
				}
			}
        }
